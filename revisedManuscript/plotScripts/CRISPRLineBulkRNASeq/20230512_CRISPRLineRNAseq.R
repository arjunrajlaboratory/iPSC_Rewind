...
# read in sample info
# at home
targets <- read_tsv("/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Revisions/extractedData/CRISPRLineBulkRNASeq/samples.tsv") # read in your study design
path <- file.path(paste0("/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Revisions/extractedData/CRISPRLineBulkRNASeq/", targets$sample, "-1/", "abundance.h5")) # set file paths to your mapped data
all(file.exists(path))

plotDirectory <- "/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Revisions/plots/CRISPRLineBulkRNASeq/"
