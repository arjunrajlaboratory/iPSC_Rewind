...
# scanorama_filter <- readRDS(paste0(homeDirectory, "scTransform.integrated"))
...
primedCells <- inner_join(probedBarcodesTopR1, linCountToOverlaps, by = "BC50StarcodeD8") %>% mutate(label = "primed")
...
saveRDS(object = oddsRatioListFilter, file = paste0(homeDirectory, "R1_oddsRatioListFilter.rds"))
