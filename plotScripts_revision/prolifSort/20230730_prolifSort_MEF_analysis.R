...
homeDirectory <- "/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Revised Manuscript/extractedData/prolifSort/"
plotDirectory <- "/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Revised Manuscript/plots/prolifSort/"

homeDirectory <- "/Users/naveenj/Dropbox (RajLab)/Shared_Naveen/Revised Manuscript/extractedData/prolifSort/"
plotDirectory <- "/Users/naveenj/Dropbox (RajLab)/Shared_Naveen/Revised Manuscript/plots/prolifSort/"
...
ggplot(prolifTable %>% dplyr::filter(!(condition == "ungated")), aes(x = condition, y = normfoldchange)) +
  ...
  geom_jitter(height = 0, width = 0.25, size = 3) +
