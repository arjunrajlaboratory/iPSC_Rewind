...
homeDirectory <- "/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Revised Manuscript/extractedData/continuousCulture/"
plotDirectory <- "/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Revised Manuscript/plots/continuousCulture/"
...
ggplot(overlapData %>% dplyr::filter(cond != "P2vsP3"), aes(x = cond, y = overlap, fill = rep)) +
