...
dataDirectory <- "/Users/naveenjain/Dropbox (RajLab)/Shared_Naveen/Paper/rawData/CRISPR/R2_smFISH/UBC A594, SPP1 CY5/"
...
spotTablePlot <- spotTable %>% filter(channel == "cy") %>% filter(!(condition %in% c("C2", "C4", "B1_1", "B1_2")))
